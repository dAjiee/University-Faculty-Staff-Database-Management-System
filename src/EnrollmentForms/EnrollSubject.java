...
public class EnrollSubject extends javax.swing.JFrame {
    SubjectCRUD sblist;
    ...
    public EnrollSubject(SubjectCRUD sblist, TeachingAssignmentCRUD tslist, TeachingAssignmentRU tsru, Teacher teacher) {
        this.sblist = sblist;
        this.tslist = tslist;
        this.tsru = tsru;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 360, 110, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 360, 110, -1));
