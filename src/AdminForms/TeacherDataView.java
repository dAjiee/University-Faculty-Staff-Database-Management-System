...
public class TeacherDataView extends javax.swing.JFrame {
    ...
    TeacherDataView(TeacherCRUD tlist, TeacherRU teacherru, EnrollmentCRUD elist, EnrollmentRU enrollru, TeachingAssignmentCRUD tslist, TeachingAssignmentRU tsru) {
        this.tlist = tlist;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(jTable1.getSelectedRow() != -1){
            ...
            tlist.deleteTeacher(tlist.retrieveTeacher(teacher));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TeacherDataForm create = new TeacherDataForm(tlist, teacherru);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TeacherDataForm update = new TeacherDataForm(tlist, teacherru, oldTeacher);
